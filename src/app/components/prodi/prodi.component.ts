...
export class ProdiComponent implements OnInit { // Mendeklarasikan class komponen dengan implementasi OnInit untuk inisialisasi.
  ...
  apiProdiUrl = 'https://express-app-smoky.vercel.app/api/prodi'; // URL API untuk mengambil dan menambahkan data prodi.
  apiFakultasUrl = 'https://express-app-smoky.vercel.app/api/fakultas'; // URL API untuk mengambil data fakultas.
